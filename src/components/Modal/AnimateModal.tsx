...
const AnimateModal: FC<Props> = ({ children, keyBody }) => {
  return (
    <motion.div
      ...
      className='absolute w-screen h-screen top-0 bg-[rgba(19,19,19,0.36)] flex p-3 z-20'
    >
      <motion.div
        key={keyBody}
        ...
        className='m-auto bg-slate-200 rounded-md min-w-[600px] min-h-[400px] overflow-hidden'
      >
        {
          children
        }
